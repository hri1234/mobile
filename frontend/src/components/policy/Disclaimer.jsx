...
<>
  ...
  <ul>
    <li>
      ...
      or "Our" in this Disclaimer) refers to E-Commerce.
    </li>
    <li>
    ...
    <li>
      ...
      <a
        href="https://upstagecommerce.com/"
        rel="external nofollow noopener"
        target="_blank"
      >
        https://upstagecommerce.com/
      </a>
    </li>
  </ul>
  <h2>Disclaimer</h2>
  ...
  <p>
    ...
    the contents on the Service at any time without prior notice. This
  ...
  <p>
    ...
    take full responsibility, liability and blame for any libel or litigation
    that results from something written in or as a direct result of something
    written in a comment. The Company is not liable for any comment published by
    users and reserves the right to delete any comment for any reason
    whatsoever.
  </p>
  ...
  <p>
    ...
    in connection with your access or use or inability to access or use the
    Service.
  </p>
  ...
  <ul>
    <li>
      ...
      <a
        ...
        data-cfemail="5025202324313735333f3d3d3522333510373d31393c7e333f3d"
      >
        [email&nbsp;protected]
      </a>
    </li>
